...
const loginicon = document.getElementById("login-or-signup");
...
function createSelectedProductsContent(image, name, price, unit, discount, preservative, time) {
    ...
    newStrong[2].textContent = 'Giảm Giá: ';
    newStrong[3].textContent = 'Số Lượng: ';
    newStrong[4].textContent = 'Chất Bảo Quản: ';
    newStrong[5].textContent = 'Thời Gian Thêm Vào: ';
    ...
    newShoppingButton[0].textContent = 'Thêm Vào Giỏ';
    newShoppingButton[1].textContent = 'Xóa Mặt Hàng';
